...
<form name="pathdetails" action="/TravelAgencyWeb/employee/EmplSelectPath"
 method="post" onsubmit="return checkForm(this);">
  ...
  <h4>Number of Passengers:</h4>
    <p>How many tickets does the Client need?</p>
  ...
  <h4>Meal:</h4>
    ...
    <input class="textbox" type="text" name="meal" value="">

  <h4>Customer Account Number:</h4>
    <p>Enter the Client's Account Number here.</p>
    <input class="textbox" type="text" name="accountNo" value=""><br>
