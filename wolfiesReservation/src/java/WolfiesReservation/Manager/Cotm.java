 ...
 */
public class Cotm extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse 
        ...
        try {
            ...
            conn = DriverManager.getConnection(url + dbName, dbUserName,   
                                            dbPassword);
            //Execute Query
            String strQuery = "SELECT CR.AccountNo, P.FirstName, "
                            + "P.LastName FROM CustomerRevenue CR, Customer "
                            + "C, Person P WHERE CR.AccountNo = C.AccountNo "
                            + "AND C.Id = P.Id AND CR.TotalRevenue >= (SELECT"+ " MAX(TotalRevenue) FROM CustomerRevenue)";
            ...
            String queryType = "Top Customer is: ";
            request.setAttribute("queriy", queryType);
