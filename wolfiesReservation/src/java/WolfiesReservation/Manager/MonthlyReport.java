    ...
    public void service(HttpServletRequest request, HttpServletResponse 
        ...
        try {
            ...
            conn = DriverManager.getConnection(url + dbName, dbUserName,   
                                            dbPassword);
            //Execute Query
            String strQuery = "SELECT R.ResrNo, R.ResrDate, R.TotalFare, " +
            "R.BookingFee, R.RepSSN, P.FirstName, P.LastName FROM Reservation"
            + " R, Customer C, Person P WHERE R.ResrDate > ? AND R.ResrDate <"
            + " ? AND R.AccountNo = C.AccountNo AND C.Id = P.Id ";
            String startDate = dateTimeConvert(month, year, false);
            String endDate = dateTimeConvert(month, year, true);
            ...
            String queryType = "Monthly Revenue Report For " + 
