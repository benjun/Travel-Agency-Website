 ...
 */
public class Eotm extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse 
        ...
        try {
            ...
            conn = DriverManager.getConnection(url + dbName, dbUserName,   
                                            dbPassword);
            //Execute Query
            String strQuery = "SELECT SSN FROM CRRevenue WHERE TotalRevenue " 
                            + " >= (SELECT MAX(TotalRevenue) FROM CRRevenue)";
            ...
            String queryType = "Top Employee is: ";
