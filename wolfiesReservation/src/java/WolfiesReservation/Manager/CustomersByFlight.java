 ...
 */
public class CustomersByFlight extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse 
        ...
        try {
            ...
            conn = DriverManager.getConnection(url + dbName, dbUserName,   
                                            dbPassword);
            //Execute Query
            String strQuery = "SELECT DISTINCT P.Id, P.FirstName, P.LastName "                + "FROM Reservation R, Includes I, "
                            + "ReservationPassenger RP, Person P WHERE "
                            + "I.AirlineID= ? AND I.FlightNo = ? AND "
                            + "I.ResrNo = R.ResrNo AND R.ResrNo = RP.ResrNo "
                            + "AND RP.Id = P.Id";
            ...
            String queryType = "Customers Reserved on Flight " + flightNo + ": ";
