 ...
 */
public class SummaryByCity extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse 
        ...
        //get form data
        String cityName = request.getParameter("summCityName");
        ...
        try {
            ...
            String strQuery = "SELECT DISTINCT R.ResrNo, R.TotalFare * 0.1 AS "
                            + "Revenue FROM Reservation R, Leg L, "
                            + "ResrFlightLastLeg LL, Airport A WHERE R.ResrNo "
                            + "= LL.ResrNo AND L.AirlineID = LL.AirlineID AND "
                            + "L.FlightNo = LL.FlightNo AND L.LegNo = "
                            + "LL.LegNo AND L.ArrAirportID = A.ID AND A.City "+ " = ? ";
            ...
            String queryType = "Revenue Generated in " + cityName + ": ";
