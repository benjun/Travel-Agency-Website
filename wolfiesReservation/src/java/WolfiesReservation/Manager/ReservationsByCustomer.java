 ...
 */
public class ReservationsByCustomer extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse 
        ...
        //get form data
        String fullname = request.getParameter("reservCustomerName");
        ...
        try {
            ...
            String strQuery = "SELECT DISTINCT R.ResrNo, R.ResrDate, "
                            ...
                            + "Customer C, Person P WHERE R.AccountNo = "
                            + "C.AccountNo AND C.Id = P.Id AND P.FirstName = "+ " ? AND P.LastName = ? ";
            ...
            String queryType = firstname + " " + lastname + "'s "
                             + "Reservations:";
