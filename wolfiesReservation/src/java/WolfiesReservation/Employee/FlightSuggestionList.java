 ...
 * @author Youngseo Son
 */
public class FlightSuggestionList extends HttpServlet {
     ...
     */
        ...
        try {
            ...
            conn = DriverManager.getConnection(url + dbName, dbUserName,   
                                            dbPassword);
            //Execute Query
            String strQuery = "SELECT I.AirlineID, I.FlightNo, COUNT(DISTINCT I.ResrNo) AS ResrCount"
                            +" FROM Includes I"
            ...
            String queryType = "Flight Suggestion List: ";
